...
const projectsData = [
  {
    ...
    description: 'A fully AI-driven telephony agent built with n8n workflows and custom serverless functions, integrating Deepgram for real-time speech-to-text, ElevenLabs for high-quality text-to-speech, and OpenRouter/OpenAI APIs for intent parsing and context-aware dialogue. Automates end-to-end call logging into Google Sheets and is containerized with Docker & docker-compose for easy local development and deployment.',
    techStack: [
      'Node.js',
      'Python',
      'n8n',
    ...
    liveDemo: '',
    github: 'https://github.com/nishant0207/ai-phone-agent',
  },
  {
